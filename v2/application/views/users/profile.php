									...
									<div class="panel-body">
										<form action="#">
											<div class="form-group">
												<div class="row">
													<div class="col-md-6">
														...
														<input type="text" value="Forename" class="form-control">
													</div>
													<div class="col-md-6">
											...
											<div class="form-group">
												<div class="row">
													<div class="col-md-6">
														...
														<input type="text" value="mail@domain.com" class="form-control">
													</div>
													<div class="col-md-6">
														<label>Interest</label>
														<input type="text" value="Roleplaying" class="form-control">
													</div>
												</div>
											</div>
											...
											<div class="form-group">
												<div class="row">
													<div class="col-md-4">
														...
														<input type="text" value="kira@gmail.com" class="form-control">
													</div>
													<div class="col-md-4">
														<label>Google</label>
														<input type="text" value="kira@gmail.com" class="form-control">
													...
													<div class="col-md-4">
														<label>Skype</label>
														<input type="text" value="kirayukiirie" class="form-control">
													</div>
												</div>
											</div> 
											...
											<div class="form-group">
												<div class="row">
													<div class="col-md-6">
														...
														<input type="text" value="+00-00-0000-0000" class="form-control">
														<span class="help-block">+00-00-0000-0000</span>
													</div>
											...
											<div class="text-right">
												<button type="submit" class="btn bg-red">Save <i class="icon-arrow-right14 position-right"></i></button>
											</div>
										</form>
									</div>
								</div>
								...
								<div class="panel panel-flat">
									...
									<div class="panel-body">
										<form action="#">
												...
												<div class="row">
													...
													<div class="col-md-6">
														...
														<div class="checkbox">
															<label>
																<input type="checkbox" class="styled" checked="checked">
																New pilot request notification
															</label>
														</div>
											...
											<div class="text-right">
												<button type="submit" class="btn bg-red-400">Save <i class="icon-arrow-right14 position-right"></i></button>
											</div>
										</form>
									</div>
								</div>
				...
				<div class="col-lg-3">
					...
					<div class="panel panel-flat">
						...
						<div class="list-group no-border no-padding-top">
							<a href="#" class="list-group-item"><i class="icon-red icon-user"></i> My profile</a>
							<a href="#" class="list-group-item"><i class="icon-red icon-cash3"></i> Order History</a>
							<a href="#" class="list-group-item"><i class="icon-red icon-airplane2"></i> Pilot Schedule</a>
							<a href="#" class="list-group-item"><i class="icon-red icon-laptop"></i> Games Played <span class="badge bg-danger pull-right">29</span></a>
							<a href="#" class="list-group-item"><i class="icon-red icon-users"></i> Friends <span class="badge bg-danger pull-right">131</span></a>
							<a href="#" class="list-group-item"><i class="icon-red icon-heart5"></i> Wishlist</a>
							<a href="#" class="list-group-item"><i class="icon-red icon-trophy3"></i> Badges</a>
							<div class="list-group-divider"></div>
							<a href="#" class="list-group-item"><i class="icon-red icon-pencil"></i> Reviews</a>
							<a href="#" class="list-group-item"><i class="icon-red icon-calendar3"></i> Activities <span class="badge bg-teal-400 pull-right">48</span></a>
							<a href="#" class="list-group-item"><i class="icon-red icon-cog3"></i> Account settings</a>
						</div>
					</div>
					<!-- /navigation -->
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							 Share your  <span class="text-red"> Thoughts </span>
							<div class="heading-elements">
								<ul class="icons-list">
									<li><a data-action="collapse"></a></li>
								</ul>
						...
						<div class="panel-body">
							<form action="#">
								...
								<div class="row">
									...
									<div class="col-xs-6 text-right">
										<button type="button" class="btn bg-red btn-labeled btn-labeled-right">Share <b><i class="icon-square-right"></i></b></button>
									</div>
								</div>
							</form>
						</div>
						...
						<ul class="media-list media-list-linked pb-5">
							...
							<li class="media">
								<a href="#" class="media-link">
									...
									<div class="media-right media-middle">
										<span class="status-mark bg-red"></span>
									</div>
								</a>
							</li>
